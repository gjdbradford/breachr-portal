...
export default function SensorHelpChat({ deploymentType, sensor, isOpen, onClose }: Props) {
    ...
    <>
      ...
      <div
        style={{
          ...
          animation: 'brchr-slide-in 0.2s ease-out',
        }}
      >
        {/* Panel header */}
        <div style={{
