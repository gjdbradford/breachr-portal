...
export default function InviteAcceptPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Set password and save name in user metadata
    ...
    // Persist name to public.users row
      ...
      <div style={{ width: '100%', maxWidth: 440 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 13, color: '#64748b', margin: 0 }}>
            {user?.email} · Set up your account to continue
          </p>
        </div>
        ...
        <div className="gs au1" style={{ padding: 32 }}>
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 16, padding: '10px 12px', borderRadius: 8, background: 'rgba(59,130,246,0.06)', border: '1px solid rgba(59,130,246,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <label style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 24, cursor: 'pointer' }}>
              <input
                ...
                style={{ marginTop: 2, flexShrink: 0, accentColor: '#42a5f5' }}
              />
